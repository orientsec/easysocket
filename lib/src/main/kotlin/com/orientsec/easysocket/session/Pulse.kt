 ...
 */
class Pulse internal constructor(
    ...
    private val lostTimes = AtomicInteger()
    ...
    init {
        val options = socketClient.options
    ...
    fun start() {
        ...
        pulseJob = socketClient.scope.launch {
            while (isActive) {
